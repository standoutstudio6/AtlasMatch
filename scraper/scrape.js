 ...
 * This is safer than trying to delete everything in a single batch.
 */
...
/**
 * Writes job docs in batches to avoid the 500 op limit.
 */
...
async function runScraper() {
  ...
  try {
    ...
    /**
     * NOTE:
     * CSS selectors on job boards can change.
     * If your run finds 0 jobs, inspect the page HTML and update selectors below.
     */
    ...
    // Write failure status so your UI can show "last run failed"
    try {
      await metaRef.set({
        ...runInfo,
        timestamp: new Date().toLocaleString('en-US', { timeZone: 'America/Chicago' }),
